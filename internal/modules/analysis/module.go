...
func Mount(mux *http.ServeMux, core Services) {
	...
	mux.HandleFunc("/api/analysis-backtest-liquidation/signals/backfill", svc.handleBacktestLiquidationSignalBackfill)
	mux.HandleFunc("/api/analysis-backtest-liquidation/signals/reset", svc.handleBacktestLiquidationSignalReset)
