...
set "DB_FILE="
set "DB_DIR="
set "RETENTION_CLEANUP_ON_START=0"
set "RETENTION_CLEANUP_INTERVAL_HOURS=12"
if not defined TELEGRAM_COMMAND_POLLER_ENABLED set "TELEGRAM_COMMAND_POLLER_ENABLED=1"
